package com.jayesh.his.ar.config;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("AR module of HIS application",
				"AR module to create applications", "1", "Term of Service",
	...
	public Docket apiDoc() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.jayesh.his.ar")).paths(PathSelectors.any()).build();
	}
